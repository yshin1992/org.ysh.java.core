package org.ysh.java.core.chapter9.fileChooserTest;
...
class ImageViewerFrame extends JFrame
{
   public ImageViewerFrame()
   {
      ...
      */
      ...
      chooser.setFileView(new FileIconView(filter, new ImageIcon(ImageViewerFrame.class.getResource("palette.gif"))));
